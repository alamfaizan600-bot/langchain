...
output = agent.invoke({"messages": [HumanMessage(content="Give me the top generative ai based jobs near gurgaon, india and new york, usa? And give me the sources as well.")]})
print(output)